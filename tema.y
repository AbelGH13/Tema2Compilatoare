...
%token TOK_PROG TOK_VAR TOK_BEGIN TOK_END TOK_INTEGER TOK_ASSIGN
%token TOK_PLUS TOK_MINUS TOK_MULTIPLY TOK_DIVIDE TOK_INT
%token TOK_READ TOK_WRITE TOK_FOR TOK_DO TOK_TO TOK_ERROR
